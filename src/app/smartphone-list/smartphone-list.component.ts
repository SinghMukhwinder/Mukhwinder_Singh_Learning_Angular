...
@Component({
  ...
  standalone: true,
  imports: [NgForOf, SmartphoneListItemComponent, NgClass, NgOptimizedImage, RouterLink, NgIf, UpperCasePipe, CurrencyPipe, DatePipe, SmartphoneDetailsPipe, HoverHighlightDirective],
